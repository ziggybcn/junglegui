...
Class Blob_Monster Extends Canvas 'App
...
Class BlobForm Extends Form
	Field game:Blob_Monster
	Method OnInit()
		game = New Blob_Monster
		game.Parent = Self
		game.Size.SetValues(200, 200)
		game.LogicSize.SetValues(640, 480)
		
		game.TipText = "Blob Monster! into a JungleGui canvas!"
		
		Self.Size.SetValues(1024, 768)
		Self.Event_Resized.Add(Self, "Form_Resized")
		Self.Text = "BLob Monster by charlie (Resize me!)"
